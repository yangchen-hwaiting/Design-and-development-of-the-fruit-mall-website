...
public class GuoshuOrderView extends GuoshuOrderEntity implements Serializable {
	...
	*/
	...
	private String guoshuOrderValue;
	...
	public GuoshuOrderView() {

	}

	public GuoshuOrderView(GuoshuOrderEntity guoshuOrderEntity) {
		try {
			BeanUtils.copyProperties(this, guoshuOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getGuoshuOrderValue() {
		return guoshuOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setGuoshuOrderValue(String guoshuOrderValue) {
		this.guoshuOrderValue = guoshuOrderValue;
	}
	...
	public String toString() {
		return "GuoshuOrderView{" +
			", guoshuOrderValue=" + guoshuOrderValue +
