...
public class GuoyuanLiuyanView extends GuoyuanLiuyanEntity implements Serializable {
	...
	public GuoyuanLiuyanView() {

	}

	public GuoyuanLiuyanView(GuoyuanLiuyanEntity guoyuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, guoyuanLiuyanEntity);
