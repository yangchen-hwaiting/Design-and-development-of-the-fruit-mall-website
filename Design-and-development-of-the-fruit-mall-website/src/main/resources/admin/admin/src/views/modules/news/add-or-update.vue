    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="水果名称" prop="newsName">
                       <el-input v-model="ruleForm.newsName"
                                 placeholder="水果名称" clearable  :readonly="ro.newsName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="水果名称" prop="newsName">
                           <el-input v-model="ruleForm.newsName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.newsPhoto" label="水果图片" prop="newsPhoto">
                        <file-upload
                            tip="点击上传水果图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.newsPhoto" label="水果图片" prop="newsPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="水果类型" prop="newsTypes">
                        <el-select v-model="ruleForm.newsTypes" :disabled="ro.newsTypes" placeholder="请选择水果类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="水果类型" prop="newsValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="水果详情" prop="newsContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.newsContent" label="水果详情" prop="newsContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   newsPhoto: [
                              { required: true, message: '水果图片不能为空', trigger: 'blur' },
                          ],
                   newsTypes: [
                   ...
                   insertTime: [
                              { required: true, message: '水果发布时间不能为空', trigger: 'blur' },
                          ],
                   newsContent: [
                              { required: true, message: '水果详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
